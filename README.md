...
参考或使用此项目请遵守附带的开源协议，如愿意分享，欢迎投稿至第三方文件夹。
...
* 安装轴体下的磁铁时，请使用压缩包内的工具代码，检查磁铁方向是否安装正确，要求按下增大，释放减小。
...
# 参考项目
1. hall-2k-keypad-handmade：https://github.com/chent7/hall-2k-keypad-handmade（主要）
